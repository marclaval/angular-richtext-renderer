...
export class RichTextRenderViewBuilder implements RenderCommandVisitor {
...
export class BuildContext {
  ...
  _builders: RichTextRenderViewBuilder[] = [];

  public enqueueBuilder(builder: RichTextRenderViewBuilder) {
    this._builders.push(builder);
  }

  public build(builder: RichTextRenderViewBuilder) {
    this._builders = [];
    builder.build(this);
